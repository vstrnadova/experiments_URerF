...
if (data == "hw"){
    ...
    print('mixture of gaussians data...')
...
t=hw_data_object[[2]]
print('computing ground truth geodesics..')
if (data == "hw")
...
print('generating varying mtry data..')
for (mtr in mtries) {
    ...
    print('running URerF on data with mtry = ...')
    ...
    print('generating precision-recall list..')
